    ...
    <aside className="sidebar" style={{ overflowY: 'auto' }}>
      <nav>
        <ul className='ulMargen'>
          ...
          <li><NavLink to="admin-tipos-aulas" activeClassName="active">Administrar Tipos de Aulas</NavLink></li>
          ...
          <li><NavLink to="admin-tipos-trabajadores" activeClassName="active">Tipos de Trabajadores</NavLink></li>
